...
This dataset contains the latitude and longitude of the ten ionizers and
their deployment timing during the 2013–2018 Oman rainfall enhancement
trial, as used in the analyses of Chambers et al. (2022a,b).
...
A data frame with 10 rows (ionizers) and 9 variables:

- Ionizer:

  Identifier for each ionizer
