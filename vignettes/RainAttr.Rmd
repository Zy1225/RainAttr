...
* More importantly, the original implementation of the `apl` estimator in Chambers et al (2022a) contained a coding error, which has been corrected in the present implementation.
...
The package can also be used to replicate the SATE analysis of Chambers et al. (2022b). published in Journal of the Royal Statistical Society Series A (Statistics in Society), "Weighting, informativeness and causal
