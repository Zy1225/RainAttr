...
```{r, out.width="90%", fig.align="center", fig.height= 9, eval = !in_cran_check}
...
* The inherent randomness of the bootstrap and permutation procedure, as well as the smaller number of bootstrap and permutation replicates used here (`bootstrap_opt(B_bootstrap = 500)` and `permutation_opt(B_permutation = 500)`) to reduce computational cost
