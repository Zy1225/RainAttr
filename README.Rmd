...
This basic example shows how to use the package for estimation, bootstrap inference, and permutation inference. For simplicity, the numbers of bootstrap and permutation replicates are both set to 100.
